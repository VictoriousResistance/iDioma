  ...
  <div className={match.willUnmount ? "person animated fadeOut" : "person"}>
    ...
    <div className="text-container">
      ...
      <div className="button-container">
        <button className="action" onClick={() => { onConnectClick(self.id, match.id, self.fbId, match.fbId); }}>Send Pair Request</button>
...
const Matches = ({ matches, onConnectClick, onHideClick, offset, onLoadMoreClick, self }) => {
  if (matches.length === 0) {
    ...
    return (
      <div className="empty-tab-message">
        <p>You don't have any matches at the moment. Come back later and check again!</p>
      </div>
    );
  }
